...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, class: 'mb-3' do |b|
    ...
    b.use :full_error, wrap_with: { class: 'invalid-feedback d-block text-danger' }
  ...
  config.wrappers :vertical_boolean, tag: 'fieldset', class: 'mb-3' do |b|
    ...
    b.wrapper :form_check_wrapper, class: 'form-check' do |bb|
      ...
      bb.use :full_error, wrap_with: { class: 'invalid-feedback d-block text-danger' }
  ...
  config.wrappers :vertical_multi_select, class: 'mb-3' do |b|
    ...
    b.use :full_error, wrap_with: { class: 'invalid-feedback d-block d-block text-danger' }
    b.use :hint, wrap_with: { class: 'form-text' }
  end
  ...
  # horizontal input for inline radio buttons and check boxes
  config.wrappers :custom_horizontal_collection_inline, item_wrapper_class: 'form-check form-check-inline', item_label_class: 'form-check-label', class: 'row mb-3' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :grid_wrapper, class: 'col-sm-9' do |ba|
      ba.use :input, class: 'form-check-input', error_class: 'is-invalid', valid_class: 'is-valid'
...
# custom inline checkbox
 config.wrappers :inline_checkbox, :tag => 'div', :class => 'control-group', :error_class => 'error' do |b|
  ...
  config.wrapper_mappings = {
    ...
    custom_check_boxes: :custom_horizontal_collection_inline,
